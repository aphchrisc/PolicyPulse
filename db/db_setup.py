...
def execute_sql_file(conn, filepath):
    ...
    try:
        ...
        if existing_types := check_enum_types(conn):
...
def main():
    ...
    # Initialize conn to None to avoid "possibly unbound" errors
    conn = None
    ...
    try:
        ...
        # Fix for "conn" possibly unbound error
        # First check if conn exists in locals, then check if it's None
