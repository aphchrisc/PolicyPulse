...
class LegislationTracker(Base):
    ...
    first_stored_date = Column(DateTime, default=datetime.utcnow)  
    ...
    def check_for_updates(self, days_threshold=1):
        ...
        try:
            ...
            for bill in bills_to_check:
                ...
                bill.last_api_check = datetime.utcnow()

                # Logic for checking updates would go here
                # This should be implemented in congress_api.py
